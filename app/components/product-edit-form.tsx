...
import { Product, Collection, apiClient } from '../lib/api-client'
            ...
            <details className="space-y-4">
              ...
              <div className="space-y-4 mt-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    URL hlavního obrázku produktu
                  </p>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="images">Další obrázky (URL)</Label>
                  <Textarea
                    id="images"
                  ...
                  <p className="text-sm text-gray-500">
                    Zadejte URL adresy dalších obrázků oddělené čárkami (max. 10)
                    {formData.images && (
